...
// Affiche le nombre de visites réel grâce à CountAPI
fetch('https://api.countapi.xyz/hit/habibmahjoubi/visites')
  .then(res => res.json())
  .then(res => {
    document.getElementById('visits-count').textContent = res.value;
  });
